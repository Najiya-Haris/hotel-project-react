...
function SingleFood() {
  return (
    <div>
    <div className='title'>name of food </div>
    <div className=''>
        <div className="">
            <img className='' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTLYxNcp7hvFQPupUs7_FhbGBXWMK5h-WxkdA&usqp=CAU"/>
        </div>
        <Card className='mb'
      title="Recipe"
